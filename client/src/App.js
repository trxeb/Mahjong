...
export default function App() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // In a real application, you would typically redirect the user to a dashboard or home page
        ...
        <Container fluid className="d-flex justify-content-center align-items-center min-vh-100 p-3">
            <Card className="p-4 p-md-5 w-100" style={{ maxWidth: '400px' }}>
                <div className="text-center mb-4">
                    ...
                    <img
                        src="/logo.jpg" // Assuming logo.jpg is in client/public folder
                        alt="Tai-ny Calculator Logo"
                        className="img-fluid mb-3"
                        style={{ maxWidth: '200px', height: 'auto', borderRadius: '15px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}
